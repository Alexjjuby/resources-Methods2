...
Simulation of data consists of creating data that can be used and follows the required assumptions of the model.
...
## Ex. 0.c) Talk with your group and note in 1-2 sentences: What do we know of the data drawn from the rnorm()? sd, mean, nr.data
...
print(e_sd)
# They are different, both are higher than the specified value with an average difference of 2.2
# The simulated data has not a sample size large enough, as accuracy increases with size.
```
